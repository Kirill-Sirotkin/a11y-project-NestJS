...
export class ReportQueueEventsListener extends QueueEventsHost {
    ...
    async onCompleted(job: { 
        ...
        this.reportService.queueUpdateReportStatus(job.jobId, QueueName.ReportQueue, 'COMPLETED');
    }
    ...
    async onFailed(job: { 
        ...
        this.reportService.queueUpdateReportStatus(job.jobId, QueueName.ReportQueue, 'FAILED');
    }
}